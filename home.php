    	...
    	<div id="main-carousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active carousel-slide-1">
					...
					<div class="container h-50 d-flex align-items-center">
						<a class="btn btn-lg jumbotron-button mx-auto" href="projects.php">See Our Works >></a>
					</div>
		    	</div>
			    <div class="carousel-item carousel-slide-2">
					...
					<div class="container h-50 d-flex align-items-center">
						<a class="btn btn-lg jumbotron-button mx-auto" href="services.php">Our Services >></a>
					</div>
		    	</div>
		  	</div>
