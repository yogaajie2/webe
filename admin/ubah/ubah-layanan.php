  ...
  <body class="h-100">
    ...
    <div class="container-fluid h-100">
      <div class="row h-100">
        ...
        <div class="col-md-10">
          <h1>Ubah Layanan</h1>
          <form action="../fungsi/update/update-layanan.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <label for="id">ID Layanan</label>
              <input type="text" class="form-control" name="id" id="id" value="<?php echo $row['id_layanan']; ?>" readonly>
            </div>
            <div class="form-group">
              <label for="nama">Nama Layanan</label>
              <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $row['nama_layanan']; ?>">
            </div>
            <div class="form-group">
