<?php
	...
	$sql = "UPDATE `motogp` SET `negara`='$negara',`kode_negara`='$kode_negara',`nomor`='$nomor',`foto`='$foto',`nama`='$nama',`foto_motor`='$foto_motor',`tim`='$tim',`motor`='$motor',`tempat_lahir`='$tempat_lahir',`tanggal_lahir`='$tanggal_lahir',`berat_badan`='$berat_badan',`tinggi_badan`='$tinggi_badan',`kemenangan_seri`='$kemenangan_seri',`kemenangan_kejuaraan`='$kemenangan_kejuaraan' WHERE `id`='$id'";
